...
export default class PrivacyPolicy extends Component{
  ...
  public render(): JSX.Element {
    return RouterOutline.set(
      <Grid.Container>
        <Grid.Row>
          <Grid.Col className="pp">
            <h1 className="font-weight-bold">
              Privacy Policy
            </h1>
            <hr />
            <p>Last updated: March 26, 2021</p>
            <p>At We to World, accessible from https://apps.weto.world, one of our main priorities is the privacy of our visitors.
              This Privacy Policy document contains types of information that is collected and recorded by We to World and how we
              use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
              the information that they shared and/or collect in We to World. This policy is not applicable to any information
            ...
            {/* <h2>Log Files</h2>
            <p>We to World follows a standard procedure of using log files. These files log visitors when they visit websites. All
            ...
            <p>Like any other website, We to World uses &#39;cookies&#39;. These cookies are used to store information including visitors&#39;
            ...
            <p>For more general information on cookies, please read <a
              href="https://www.privacypolicyonline.com/what-are-cookies/" target="_blank" rel="noreferrer nofollow noopener">&quot;What Are Cookies&quot; from Cookie Consent</a>.</p>
            <h2>Advertising Partners Privacy Policies</h2>
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of We to World.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
              their respective advertisements and links that appear on We to World, which are sent directly to users&#39; browser. They
            ...
            <p>Note that We to World has no access to or control over these cookies that are used by third-party advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>We to World&#39;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
            ...
            <p>We to World does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
