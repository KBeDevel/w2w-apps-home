...
export default class ContactsForm extends Component<EmptyProps, ContactsBFormFields & FormState>{
  ...
  render():JSX.Element{
    return RouterOutline.set(
      <Grid.Container className='pt-5 pb-5'>
        <Form id='contactBookForm' name='contactBookForm' onSubmit={ (event) => { this.handleFormSubmit(event) } } >
          <Grid.Row>
            <Grid.Col xs='12' md='12' lg='6'>
              <h3>Datos de Despacho</h3>
            </Grid.Col>
            <Grid.Col xs='12' md='12' lg='6'>
              <Button variant='warning' type='submit' size='lg'>Añadir Contacto</Button>
              <LinkContainer to='/calculator'>
                <Button variant='warning' type='button' size='lg' className='ml-2'>Ir a Cotizar</Button>
              </LinkContainer>
              <LinkContainer to='/contacts-book'>
                <Button variant='warning' type='button' size='lg' className='ml-2'>Libreta</Button>
              </LinkContainer>
            </Grid.Col>
          </Grid.Row>
          <hr style={{height: '1px', }}/>
          <Grid.Row>
            <Grid.Col xs='12' md='12' lg='6' className='mt-3'>
            ...
            <Grid.Col xs='12' md='12' lg='4'>
              <Form.Group controlId='cBookStreetName'  className='mt-3' style={{ paddingBottom: '2rem' }} >
            ...
            <Grid.Col xs='12' md='12' lg='2'>
              <Form.Group controlId='cBookStreetNumber' className='mt-3' style={{ paddingBottom: '2rem' }} >
